const fs = require("fs")
const docs = require("../../elements/dist/docs.json")
...
for (const component of docs.components) {
  ...
  const docUrl = "https://elements.inovex.de/dist/latest/storybook"
  ...
  components.push({
    ...
    source: {
      module: "@elements/" + component.filePath.replace("./src/", "dist/types/").replace(".tsx", ".d.ts"),
